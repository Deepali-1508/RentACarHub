        ...
        <div className="container">
          <div className="faq-content">
            <div className="faq-content__title">
              ...
              <p>
                Frequently Asked Questions About the RentACarHub Booking Process
            ...
            <div className="all-questions">
              ...
              <div className="faq-box">
                ...
                >
                  <p>2. How do I find the RentACarHub deals?</p>
                  <IconChevronDown />{" "}
                </div>
                <div
                  id="q2"
                ...
                >
                  You can find RentACarHub deals by researching online and
